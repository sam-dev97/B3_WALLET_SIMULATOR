...
from .views import HomeIndexView, UserRegisterView, custom_logout, TickerInfoView, TransactionHistoryView, WalletDetailsView, UserLoginView, BugReportView
...
urlpatterns = [
    ...
    path('bug_report/', BugReportView.as_view(), name='bug_report'),
